...
#undef yyFlexLexer
#define yyFlexLexer bib_FlexLexer // the trick with prefix; no namespace here :(
#include <FlexLexer.h>
#endif
...
#undef YY_DECL
#define YY_DECL bib::parser::symbol_type bib::scanner::get_next_token()
...
public:
    scanner() {}
    virtual ~scanner() {}
    virtual bib::parser::symbol_type get_next_token();
};
