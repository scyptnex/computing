 ...
 * @verbatim % openssl enc -d -p -a -md sha1 -aes-256-cbc -pass pass:'Tally Ho!' -in x.txt @endverbatim
 *
 ...
 * @verbatim openssl enc -d -a -p -md sha1 -aes-256-cbc -pass pass:'Tally Ho!' -in y.txt @endverbatim
 *
